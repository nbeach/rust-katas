...
mod tests {
    ...
    #[test]
    fn fizzbuzz_when_a_number_is_given_returns_the_number() {
        assert_eq!(fizzbuzz(1), "1");
        assert_eq!(fizzbuzz(4), "4");
    }

    #[test]
    fn fizzbuzz_when_a_multiple_of_3_is_given_returns_fizz() {
        assert_eq!(fizzbuzz(3), "fizz");
        assert_eq!(fizzbuzz(9), "fizz");
    }

    #[test]
    fn fizzbuzz_when_a_multiple_of_5_is_given_returns_fizz() {
        assert_eq!(fizzbuzz(10), "buzz");
        assert_eq!(fizzbuzz(25), "buzz");
    }

    #[test]
    fn fizzbuzz_when_a_multiple_of_3_and_5_is_given_returns_fizzbuzz() {
